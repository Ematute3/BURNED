...
object FlyWheel: Subsystem {
    ...
    @JvmField var flywheelPIDController: PIDController = PIDController(0.0075,0.0,0.0)

    @JvmField var flywheelFFCoefficients: SimpleFFCoefficients = SimpleFFCoefficients(0.064,0.00043,0.0)
